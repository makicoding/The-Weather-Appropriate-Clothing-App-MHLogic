...
// All the different clothing options available: "Sunscreen", "Sunglasses", "Women's Summer Hat", "Men's Cap", "T-Shirt", "Skirt", "Shorts", "Sweater", "Pants", "Women's Jacket", "Men's Jacket", "Umbrella", "Rain Boots", "Women's Winter Coat", "Men's Winter Jacket", "Thermal Underwear Top", "Thermal Underwear Bottom", "Scarf", "Gloves", "Winter Hat", "Snow Boots"
...
// ------------------------------
// Call Google Maps API, then call Darksky Weather API, then populate weather data
...
if (tShirt === true) {
  clothingArray.push("T-Shirt");                      // push "T-Shirt" to var clothingArray
};
...
var itemtShirt = {
  image: "assets/icons/100px_iconTShirt.png",
  keyword: "T-Shirt"
}
...
for (var i = 0; i < clothingArray.length; i++) {
  ...
  else if (clothingArray[i] === "T-Shirt") {
    createIcon(itemtShirt);                                       // Call the function createIcon and pass through itemtShirt in place of where clothing is
  }
